...
import ProfilePhoto from "../assets/vivy-profile1.jpg";
      ...
      >
        ...
        >
          ...
          >
            ...
            <div className="absolute inset-0 bg-linear-to-tr from-blue-100/50 to-cyan-100/50 filter blur-[60px] -z-10" />
            ...
            <div className="absolute inset-0">
              ...
              <motion.div
                className="absolute -top-3 -right-3 w-24 h-1 bg-linear-to-tr from-blue-400 to-cyan-400"
                animate={{
                  x: [0, 5, 0],
                  opacity: [0.6, 1, 0.6],
                }}
              ...
              />
              <motion.div
                className="absolute -bottom-3 -left-3 w-24 h-1 bg-linear-to-tr from-cyan-400 to-blue-400"
                animate={{
                  x: [0, -5, 0],
                  opacity: [0.6, 1, 0.6],
                }}
              ...
              />
              <motion.div
                className="absolute -left-3 -top-3 h-24 w-1 bg-linear-to-b from-blue-400 to-cyan-400"
                animate={{
                  y: [0, 5, 0],
                  opacity: [0.6, 1, 0.6],
                }}
            ...
            <div className="absolute inset-4 overflow-hidden bg-white/80 backdrop-blur-sm border border-gray-100">
              ...
              <div className="relative w-full h-full">
                ...
                {/* Light theme overlay */}
                <div className="absolute inset-0 bg-linear-to-t from-white/40 to-transparent opacity-50" />
              </div>
            </div>
        ...
        >
          ...
          >
            Junior SWE | Game Developer | Tech Enthusiast
          </motion.p>
          ...
          >
            Fresh graduate with a strong passion for technology, committed to
          ...
          >
            <div className="flex flex-row gap-4 items-center">
              ...
              <div
                ...
                className="relative w-35 overflow-hidden rounded-md"
              >
                <div className="absolute inset-0">
                  <div className="absolute inset-0 bg-linear-to-r from-blue-400 via-indigo-400 to-blue-400 animate-gradient-xy" />
                </div>
            ...
            >
              ...
              <a
                href="https://discordapp.com/users/500956488747974656"
                target="_blank"
                rel="noopener noreferrer"
                className="text-gray-500 hover:text-blue-600 transition-all duration-300 hover:scale-125 hover:rotate-12"
              >
                <img
                  src={DiscordSvg}
                  alt="Discord"
                  className="w-10 h-10 hover:text-blue-400"
                />
              </a>
            </motion.div>
          </motion.div>
